...
public partial class CadastroCapturaViewModel
{
    ...
    {
        _tatu = tatu;
        ParametrosFisiologicos = new ObservableCollection<ParametroFisiologicoModel> { new ParametroFisiologicoModel() };
    }
    ...
    public ObservableCollection<CampoCadastroModel> FichaAnestesica { get; } =
    [
    ...
    public ObservableCollection<ParametroFisiologicoModel> ParametrosFisiologicos { get; set; }

    [RelayCommand]
    private void AdicionarParametrosFisiologicos()
    {
